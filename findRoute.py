...
def get_routes(from_point_id, point_ids, points_json, routes_json, num_trucks=1):
...
with open("data/points.geojson", 'r') as f:
    points_json = json.load(f)

with open("data/routes.json", 'r') as f:
    routes_json = json.load(f)

print(get_routes(0, [4, 5, 6, 11, 12, 13, 10, 19, 7], points_json, routes_json, num_trucks=2))